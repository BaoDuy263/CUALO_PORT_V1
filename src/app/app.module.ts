...
import { WeighingIndexComponent } from './dashboard-module/Component/weighing/weighing-index/weighing-index.component';
import { WeighingImgsComponent } from './dashboard-module/Component/weighing/weighing-imgs/weighing-imgs.component';
...
@NgModule({
  declarations: [
    ...
    WeighingIndexComponent,
    WeighingImgsComponent,
    // ContInfoComponent,
